...
def decam():
    ...
    T = fits_table('../data/decam-tiles_obstatus.fits')
    # T = fits_table('../data/decam-tiles-bliss-v1.fits')
    ...
    F = fitsio.FITS(os.path.join(os.path.dirname(__file__), '../data/decam.wcs')) 
    wcs = []
